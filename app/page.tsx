            ...
            <div className="bg-white shadow-lg p-5 w-full rounded-3xl max-w-screen-sm dark:bg-gray-600">
                <div>
                    ...
                    <div className="my-2 flex items-center gap-2">
                        <span className="bg-green-400 text-white uppercase px-2.5 py-1.5 text-xs font-medium rounded-full transition hover:bg-green-500 hover:scale-110">Today</span>
